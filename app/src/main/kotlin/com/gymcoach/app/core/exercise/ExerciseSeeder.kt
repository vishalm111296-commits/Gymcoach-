...
class ExerciseSeeder @Inject constructor(
    ...
    private suspend fun seedEquipment(): Map<String, Long> {
        val equipmentNames = linkedSetOf<String>()
    ...
    private suspend fun seedExercises(
        ...
        for (file in ALL_EXERCISE_FILES) {
            ...
            for (i in 0 until root.length()) {
                ...
                val stableId = e.getString("id")
                if (stableId in result) continue
                ...
                val entity = ExerciseEntity(
                    ...
                    imageUrl = e.optString("image_url").takeIf { it.isNotBlank() },
                    ...
                    tempoGuidance = e.optString("tempo"),
    ...
    private suspend fun seedSubstitutions(exerciseIds: Map<String, Long>) {
        ...
        while (keys.hasNext()) {
            ...
            db.exerciseSubstitutionDao().deleteByExerciseId(originalRow)
