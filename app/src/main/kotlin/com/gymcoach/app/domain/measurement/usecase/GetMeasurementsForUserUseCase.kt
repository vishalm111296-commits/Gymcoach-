...
class GetMeasurementsForUserUseCase @Inject constructor(
    private val repository: MeasurementRepository
) {
    operator fun invoke(userId: String): Flow<List<MeasurementRecord>> {
        return repository.getMeasurementsForUser(userId)
    }
}
