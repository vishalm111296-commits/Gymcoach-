...
- [x] `./gradlew test` passes — 165+ JVM Unit Tests PASS (100% in CI Runs 34701084546, 34701773741, 34726944722).
- [x] `./gradlew connectedAndroidTest` passes — 39/39 unfiltered connected tests PASS on Android 14 (API 34) emulator in CI (Runs 34701084546, 34726944722).
- [x] Android Lint passes — 0 errors, 0 code/resource warnings (CI Runs 34701084546, 34726944722).
